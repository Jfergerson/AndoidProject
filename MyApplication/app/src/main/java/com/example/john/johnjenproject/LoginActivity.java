...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String result = null;
            InputStream in = null;
            Log.d("userlogintask",mUsername);
            try {

                String username = mUsername;
                String password = mPassword;
                JSONObject cred = new JSONObject();
                cred.accumulate("username", username);
                cred.accumulate("password", password);
                Log.d("jsonformatting", cred.toString());
                ...
                Log.d("response code",Integer.toString(i));
        ...
        private String getQuery(List<AbstractMap.SimpleEntry> params) //throws UnsupportedEncodingException
        {
            ...
            for (AbstractMap.SimpleEntry pair : params)
            {
                ...
                }catch(Exception e){Log.d("\n\n\nexception getquery",e.toString());}
            }
